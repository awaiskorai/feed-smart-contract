...
import { FeedContractClient } from './contract/clients/FeedContractClient'
...
const App = () => {
  ...
  const contractClient = useMemo(() => {
    ...
    return new FeedContractClient(lcd, connectedWallet, contractAddress('feed-contract', connectedWallet));
  }, [lcd, connectedWallet]);
